  ...
  return (
    ...
    >
      <div className="container">
          ...
          <div className="col-lg-4 mt-30">
            <div className="footer__widget footer__subscribe">
              ...
              <p>
                ...
                Voluptate necessitatibus vero porro magnam quae ratione illum.
              </p>
              <form action="">
                <input type="text" placeholder="dhruvedevansh@gmail.com" />
                <button>
                  <IoIosSend />
                </button>
              </form>
        ...
        <div className="footer__bottom ul_li_between mt_50">
        ...
        <div className="container">
          <div className="footer__copyright-inner ul_li_between">
            <div className="footer__copyright-text mt-15">
              Copyright @2024 @devanshdhruve. All rights reserved.
            </div>
