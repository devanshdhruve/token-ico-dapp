  ...
  return (
    <section id="about" className="about pos-rel pb-140">
      <div className="container">
        <div className="row align-items-center mt-none-20">
          ...
          <div className="col-lg-6 mt-30">
            ...
            >
              <div className="sec-title mb-35">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Magni, quaerat. Sunt omnis deserunt earum perspiciatis
                  distinctio, optio nemo dolor maxime necessitatibus repudiandae
                  est similique quia numquam ipsam ea, iure voluptatem!
                </p>
              </div>
